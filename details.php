            ...
            <div class="container">
             ...
             <?php get_blog_details();?>
                    ...
                    <div class="coment-form">
                        <h4>Total Comments(<?php get_comment_num(); ?>)</h4>
                        <form method="POST">
                         
                                    <input name="s" type="text" placeholder="leave your comment "  required="">
...
if (isset($_POST['submit_comment'])){
    ...
    $blog=$_GET['id'];
$comment = $_POST['s'];
$add_comment = "insert into comment (blogid,comments) values ('$blog','$comment')";
$run_comment = mysqli_query($connect, $add_comment);
if ($run_comment){
    echo "<script>window.open('details.php?id=$blog','_self')</script>";
}
}
